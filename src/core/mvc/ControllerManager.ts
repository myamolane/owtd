...
class ControllerManager extends BaseClass {
     ...
     *
     */
    public register(key:string, control:BaseController):void {
     ...
     *
     */
    public applyFunc(controllerD:string, key:string, ...param:any[]):any {
     ...
     * @returns {BaseModel}
     */
    public getControllerModel(controllerD:string):BaseModel {
        var manager:BaseController = this._modules[controllerD];
        if (manager) {
