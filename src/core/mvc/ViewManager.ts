class ViewManager extends BaseClass {
     ...
     * @param view 面板
     */
    public register(key:string, view:IBaseView):void {
        if (view == null) {
            return;
        }
        if (this._views[key]) {
     ...
     * @param newView 新面板
     */
    public destroy(key:string, newView:IBaseView = null):void {
     ...
     *
     */
    public open(key:string, ...param:any[]):IBaseView {
     ...
     *
     */
    public close(key:string, ...param:any[]):void {
        if (!this.isShow(key)) {
            return;
        }
     ...
     * @returns {any}
     */
    public getView(key:string):IBaseView {
     ...
     * @returns {boolean}
     */
    public isShow(key:string):boolean {
