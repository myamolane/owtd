...
class TimerManager extends BaseClass {
    ...
    private onEnterFrame():void {
        ...
        for (var i:number = 0; i < this._count; i++) {
            ...
            if (t >= handler.exeTime) {
                ...
                handler.method.call(handler.methodObj, ...handler.methodParams, (this._currTime - handler.dealTime) * this._timeScale);
     ...
     *
     */
    public doTimer(delay:number, repeatCount:number, method:Function, methodObj:any, methodParams: any = null, complateMethod:Function = null, complateMethodObj:any = null, complateMethodParams: any = null):void {
     ...
     *
     */
    public doFrame(delay:number, repeatCount:number, method:Function, methodObj:any, methodParams:any = null, complateMethod:Function = null, complateMethodObj:any = null, complateMethodParams:any = null):void {
